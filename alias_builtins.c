...
/**
 * set_alias - Either sets an existing alias 'name' with a new value,
...
/**
 * print_alias - Will print the alias in the format name='value'.
...
/**
 * replace_aliases - Passes through the arguments and replaces any alias that matches
 * with their value.
